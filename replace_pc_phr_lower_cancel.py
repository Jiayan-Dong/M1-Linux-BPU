...
for i in range(0, 20):
	...
	for j in range(2,19):
		with open("mispred_test.s", "w") as file:
			...
			file.write(up.format(rand_b=2, rand_t=j, rand_b_2nd=2, rand_t_2nd=j+1, mid_dummy=100-i, co_b=2, co_t=2))
...
csvFilename = "phr_Firestrom_target_address_lower_phr_cancel"
